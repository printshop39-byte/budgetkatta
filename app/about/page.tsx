...
export default function AboutPage() {
  ...
  return (
    <PageShell titleKey="about.title" subtitleKey="about.subtitle">
      ...
      >
        <p className="text-base leading-relaxed text-white/80 font-deva">{t('about.intro')}</p>
        <p className="text-base leading-relaxed text-white/70 font-deva">{t('about.compare')}</p>
        <p className="text-base leading-relaxed text-white/70 font-deva">{t('about.ai')}</p>
      </motion.div>
