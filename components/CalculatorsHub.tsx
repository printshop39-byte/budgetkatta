...
function SipCalc() {
  ...
  return (
    ...
    >
      ...
      <div className="lg:col-span-7 space-y-8">
        <div>
          <div className="flex justify-between items-center mb-3">
            <label className="text-base font-bold text-slate-700">मासिक गुंतवणूक (Monthly SIP)</label>
            <span className="text-lg font-extrabold text-teal-700 bg-teal-50 px-3 py-1 rounded-xl border border-teal-100">
        ...
        <div>
          <div className="flex justify-between items-center mb-3">
            <label className="text-base font-bold text-slate-700">अपेक्षित वार्षिक परतावा (Expected Return Rate)</label>
            <span className="text-lg font-extrabold text-teal-700 bg-teal-50 px-3 py-1 rounded-xl border border-teal-100">
              {sipRate}%
            </span>
          </div>
        ...
        <div>
          <div className="flex justify-between items-center mb-3">
            <label className="text-base font-bold text-slate-700">कालावधी (Time Period)</label>
            <span className="text-lg font-extrabold text-teal-700 bg-teal-50 px-3 py-1 rounded-xl border border-teal-100">
              {sipYears} वर्षे
            </span>
          </div>
        ...
        {/* Educational Tip */}
        <div className="bg-emerald-50/50 border border-emerald-100 p-5 rounded-2xl flex items-start space-x-3.5">
          <div className="p-2 bg-emerald-100 rounded-xl text-emerald-700">
            <Sparkles className="h-5 w-5" />
          </div>
          <div>
            <h4 className="text-sm font-bold text-emerald-800">चक्रवाढ व्याजाचा सुवर्ण सल्ला</h4>
      ...
      <div className="lg:col-span-5 flex flex-col justify-between bg-slate-50/80 border border-slate-100 p-8 rounded-3xl">
        <div className="space-y-6">
          <h3 className="text-lg font-bold text-slate-800">गुंतवणुकीचे विश्लेषण</h3>

          <div className="space-y-4">
            <div className="flex justify-between items-center py-2.5 border-b border-slate-200/50">
              <span className="text-sm text-slate-500 font-medium">एकूण गुंतवलेली रक्कम</span>
              <span className="text-base font-bold text-slate-800">{formatCurrency(sipResult.totalInvested)}</span>
            </div>
            <div className="flex justify-between items-center py-2.5 border-b border-slate-200/50">
              <span className="text-sm text-slate-500 font-medium">अंदाजे मिळालेला परतावा</span>
              <span className="text-base font-bold text-emerald-600">+{formatCurrency(sipResult.wealthGained)}</span>
            </div>
            <div className="flex justify-between items-center py-3">
              <span className="text-base font-bold text-slate-800">एकूण अंदाजे मूल्य</span>
              <span className="text-xl font-extrabold text-teal-700">{formatCurrency(sipResult.totalValue)}</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-center space-x-4 text-xs font-semibold">
          <div className="flex items-center space-x-1.5">
            ...
            <span className="text-slate-500">गुंतवणूक ({Math.round((sipResult.totalInvested / sipResult.totalValue) * 100) || 0}%)</span>
          </div>
          <div className="flex items-center space-x-1.5">
            <span className="h-3 w-3 rounded-full bg-emerald-500" />
            <span className="text-slate-500">वाढलेली संपत्ती ({Math.round((sipResult.wealthGained / sipResult.totalValue) * 100) || 0}%)</span>
          </div>
        </div>
      </div>
    </motion.div>
  ...
  return (
    ...
    >
      ...
      <div className="lg:col-span-7 space-y-8">
        <div>
          <div className="flex justify-between items-center mb-3">
            <label className="text-base font-bold text-slate-700">गुंतवणूक रक्कम (Principal Amount)</label>
            <span className="text-lg font-extrabold text-amber-700 bg-amber-50 px-3 py-1 rounded-xl border border-amber-100">
        ...
        <div>
          <div className="flex justify-between items-center mb-3">
            <label className="text-base font-bold text-slate-700">वार्षिक व्याजदर (Rate of Interest)</label>
            <span className="text-lg font-extrabold text-amber-700 bg-amber-50 px-3 py-1 rounded-xl border border-amber-100">
              {fdRate}%
            </span>
          </div>
        ...
        <div>
          <div className="flex justify-between items-center mb-3">
            <label className="text-base font-bold text-slate-700">कालावधी (Tenure)</label>
            <span className="text-lg font-extrabold text-amber-700 bg-amber-50 px-3 py-1 rounded-xl border border-amber-100">
              {fdYears} वर्षे
            </span>
          </div>
        ...
        <div>
          <label className="text-base font-bold text-slate-700 block mb-3">व्याज चक्रवाढ पद्धत (Compounding Frequency)</label>
      ...
      <div className="lg:col-span-5 flex flex-col justify-between bg-slate-50/80 border border-slate-100 p-8 rounded-3xl">
        <div className="space-y-6">
          <h3 className="text-lg font-bold text-slate-800">ठेवींचे तपशील</h3>

          <div className="space-y-4">
            <div className="flex justify-between items-center py-2.5 border-b border-slate-200/50">
              <span className="text-sm text-slate-500 font-medium">मूळ रक्कम (Principal)</span>
              <span className="text-base font-bold text-slate-800">{formatCurrency(fdResult.principal)}</span>
            </div>
            <div className="flex justify-between items-center py-2.5 border-b border-slate-200/50">
              <span className="text-sm text-slate-500 font-medium">मिळालेले व्याज</span>
              <span className="text-base font-bold text-emerald-600">+{formatCurrency(fdResult.interestEarned)}</span>
            </div>
            <div className="flex justify-between items-center py-3">
              <span className="text-base font-bold text-slate-800">एकूण मॅच्युरिटी रक्कम</span>
              <span className="text-xl font-extrabold text-amber-700">{formatCurrency(fdResult.totalValue)}</span>
            </div>
          </div>
        </div>
        ...
        <div className="my-6 space-y-2">
          ...
          <div className="w-full h-4 bg-slate-200 rounded-full overflow-hidden flex">
            ...
            <div style={{ width: `${(fdResult.interestEarned / fdResult.totalValue) * 100}%` }} className="h-full bg-emerald-500" />
          </div>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="lg:col-span-7 space-y-8">
        <div>
          <div className="flex justify-between items-center mb-3">
            <label className="text-base font-bold text-slate-700">कर्ज रक्कम (Loan Amount)</label>
            <span className="text-lg font-extrabold text-blue-700 bg-blue-50 px-3 py-1 rounded-xl border border-blue-100">
        ...
        <div>
          <div className="flex justify-between items-center mb-3">
            <label className="text-base font-bold text-slate-700">व्याजदर (Interest Rate)</label>
            <span className="text-lg font-extrabold text-blue-700 bg-blue-50 px-3 py-1 rounded-xl border border-blue-100">
              {loanRate}%
            </span>
          </div>
        ...
        <div>
          <div className="flex justify-between items-center mb-3">
            <label className="text-base font-bold text-slate-700">कर्ज कालावधी (Tenure)</label>
            <span className="text-lg font-extrabold text-blue-700 bg-blue-50 px-3 py-1 rounded-xl border border-blue-100">
              {loanYears} वर्षे
            </span>
          </div>
      ...
      <div className="lg:col-span-5 flex flex-col justify-between bg-slate-50/80 border border-slate-100 p-8 rounded-3xl">
        <div className="space-y-6">
          <h3 className="text-lg font-bold text-slate-800">हप्त्याचे विश्लेषण</h3>

          <div className="space-y-4">
            <div className="flex justify-between items-center py-2.5 border-b border-slate-200/50">
              <span className="text-sm text-slate-500 font-medium">मासिक हप्ता (Monthly EMI)</span>
              <span className="text-lg font-extrabold text-slate-800">{formatCurrency(emiResult.monthlyEmi)}</span>
            </div>
            <div className="flex justify-between items-center py-2.5 border-b border-slate-200/50">
              <span className="text-sm text-slate-500 font-medium">एकूण देय कर्ज रक्कम</span>
              <span className="text-sm font-bold text-slate-700">{formatCurrency(loanAmount)}</span>
            </div>
            <div className="flex justify-between items-center py-2.5 border-b border-slate-200/50">
              <span className="text-sm text-slate-500 font-medium">एकूण देय व्याज</span>
              <span className="text-sm font-bold text-rose-600">+{formatCurrency(emiResult.totalInterest)}</span>
            </div>
            <div className="flex justify-between items-center py-3">
              <span className="text-base font-bold text-slate-800">एकूण फेडायची रक्कम</span>
              <span className="text-xl font-extrabold text-blue-700">{formatCurrency(emiResult.totalPayment)}</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-center space-x-4 text-xs font-semibold">
          <div className="flex items-center space-x-1.5">
            ...
            <span className="text-slate-500">कर्ज ({Math.round((loanAmount / emiResult.totalPayment) * 100) || 0}%)</span>
          </div>
          <div className="flex items-center space-x-1.5">
            <span className="h-3 w-3 rounded-full bg-rose-600" />
            <span className="text-slate-500">व्याज ({Math.round((emiResult.totalInterest / emiResult.totalPayment) * 100) || 0}%)</span>
          </div>
        </div>
      </div>
    </motion.div>
  ...
  return (
    ...
    >
      ...
      <div className="lg:col-span-7 space-y-8">
        <div>
          <div className="flex justify-between items-center mb-3">
            <label className="text-base font-bold text-slate-700">तुमचे वार्षिक उत्पन्न (Annual Income)</label>
            <span className="text-lg font-extrabold text-rose-700 bg-rose-50 px-3 py-1 rounded-xl border border-rose-100">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div>
            <label className="text-sm font-bold text-slate-700 block mb-2.5">तुमचे वय (Age)</label>
            <input
              type="number"
              value={insAge}
              onChange={(e) => setInsAge(Math.min(80, Math.max(18, Number(e.target.value))))}
              className="w-full px-4 py-3 bg-white border border-slate-200 rounded-2xl text-slate-800 font-bold focus:outline-none focus:border-rose-500"
            />
          </div>

          <div>
            <label className="text-sm font-bold text-slate-700 block mb-2.5">अवलंबून असलेले सदस्य</label>
            <input
              type="number"
              value={insDependents}
          ...
          <div>
            <label className="text-sm font-bold text-slate-700 block mb-2.5">सध्याचे कर्ज (Liabilities)</label>
            <input
              type="number"
              step="50000"
        ...
        <div className="bg-rose-50/50 border border-rose-100 p-5 rounded-2xl">
          <h4 className="text-sm font-bold text-rose-800 flex items-center space-x-2">
            <AlertTriangle className="h-4.5 w-4.5 text-rose-600" />
            <span>काही महत्त्वाची माहिती:</span>
          </h4>
          <p className="text-xs text-rose-700/95 leading-relaxed mt-2">
      ...
      <div className="lg:col-span-5 flex flex-col justify-between bg-slate-50/80 border border-slate-100 p-8 rounded-3xl">
        <div className="space-y-6">
          <h3 className="text-lg font-bold text-slate-800">शिफारस केलेले विमा संरक्षण</h3>
          ...
          <div className="bg-white p-5 rounded-2xl border border-rose-100 shadow-sm space-y-2">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs font-bold text-slate-500">Term Life Cover (टर्म लाइफ कव्हर)</span>
            </div>
            <div className="text-2xl font-extrabold text-slate-800">{formatCurrency(insResult.termCover)}</div>
          ...
          <div className="bg-white p-5 rounded-2xl border border-emerald-100 shadow-sm space-y-2">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs font-bold text-slate-500">Health Cover (आरोग्य विमा कव्हर)</span>
            </div>
            <div className="text-2xl font-extrabold text-slate-800">{formatCurrency(insResult.healthCover)}</div>
        ...
        <div className="mt-6">
          <a
            ...
            className="w-full py-3 px-4 rounded-2xl bg-slate-900 text-white font-bold text-xs flex items-center justify-center space-x-2 hover:bg-slate-800 transition-all text-center"
          >
  ...
  return (
    ...
    >
      ...
      <div className="lg:col-span-6 space-y-6">
        <div>
          <div className="flex justify-between items-center mb-3">
            <label className="text-base font-bold text-slate-700">मासिक एकूण उत्पन्न (Monthly Income)</label>
            <span className="text-lg font-extrabold text-indigo-700 bg-indigo-50 px-3 py-1 rounded-xl border border-indigo-100">
        ...
        <div className="space-y-4">
          <h3 className="text-sm font-bold text-slate-600 uppercase tracking-wider">प्रत्यक्ष मासिक खर्च व गुंतवणूक मोजा:</h3>

          {/* Category: Needs */}
          <div className="bg-indigo-50/20 border border-indigo-100/40 p-4.5 rounded-2xl space-y-3">
            <div className="flex justify-between items-center">
              <span className="text-xs md:text-sm font-bold text-indigo-950">५०% - आवश्यक गरजा (Needs)</span>
              <span className="text-[11px] font-bold text-indigo-800 bg-indigo-50 px-2 py-0.5 rounded-lg">
          ...
          {/* Category: Wants */}
          <div className="bg-amber-50/20 border border-amber-100/40 p-4.5 rounded-2xl space-y-3">
            <div className="flex justify-between items-center">
              <span className="text-xs md:text-sm font-bold text-amber-950">३०% - वैयक्तिक इच्छा (Wants)</span>
              <span className="text-[11px] font-bold text-amber-800 bg-amber-50 px-2 py-0.5 rounded-lg">
          ...
          {/* Category: Savings */}
          <div className="bg-emerald-50/20 border border-emerald-100/40 p-4.5 rounded-2xl space-y-3">
            <div className="flex justify-between items-center">
              <span className="text-xs md:text-sm font-bold text-emerald-950">२०% - बचत व गुंतवणूक (Savings)</span>
              <span className="text-[11px] font-bold text-emerald-800 bg-emerald-50 px-2 py-0.5 rounded-lg">
      ...
      <div className="lg:col-span-6 flex flex-col justify-between bg-slate-50/80 border border-slate-100 p-8 rounded-3xl">
        <div className="space-y-6">
          <h3 className="text-lg font-bold text-slate-800">बजेट तुलना व सल्ला</h3>

          <div className="space-y-5">
            {/* Needs Progress */}
            <div className="space-y-2">
              <div className="flex justify-between text-xs font-bold">
                <span className="text-indigo-950">आवश्यक गरजा (Needs)</span>
                <span className={totalNeedsSpent > targetNeeds ? "text-rose-600" : "text-emerald-600"}>
              ...
              {totalNeedsSpent > targetNeeds && (
                <p className="text-[11px] text-rose-600 font-semibold">⚠️ आपका गरजांवरील खर्च निश्चित मर्यादेपेक्षा जास्त आहे!</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-xs font-bold">
                <span className="text-amber-950">वैयक्तिक इच्छा (Wants)</span>
                <span className={totalWantsSpent > targetWants ? "text-rose-600" : "text-emerald-600"}>
              ...
              {totalWantsSpent > targetWants && (
                <p className="text-[11px] text-rose-600 font-semibold">⚠️ तुमच्या चैनीच्या वस्तू व इच्छेवर जास्त खर्च होत आहे. यात कपात करा.</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-xs font-bold">
                <span className="text-emerald-950">बचत व गुंतवणूक (Savings)</span>
                <span className={totalSavingsSpent < targetSavings ? "text-amber-600" : "text-emerald-600"}>
              ...
              <div className="w-full h-3.5 bg-slate-200 rounded-full overflow-hidden">
                <div
                  ...
                  className={`h-full rounded-full transition-all duration-500 ${
                    totalSavingsSpent < targetSavings ? "bg-amber-400" : "bg-emerald-500"
                  }`}
                />
              </div>
              {totalSavingsSpent < targetSavings ? (
                <p className="text-[11px] text-amber-600 font-semibold">⚠️ तुमची गुंतवणूक ठरवलेल्या बचतीच्या लक्ष्यापेक्षा कमी आहे, यात वाढ करा!</p>
              ) : (
                <p className="text-[11px] text-emerald-600 font-semibold">🎉 उत्तम! तुम्ही तुमचे मासिक बचतीचे उद्दिष्ट गाठले आहे.</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 pt-5 border-t border-slate-200/50 flex items-center justify-between">
          ...
          <button
            ...
            className="px-4 py-2 bg-white border border-slate-200 hover:border-slate-300 text-slate-600 hover:text-slate-800 rounded-xl text-xs font-bold flex items-center space-x-1.5 transition-all"
          >
  ...
  return (
    ...
    >
      ...
      <div className="lg:col-span-7 space-y-8">
        {/* Goal Type */}
        <div>
          <label className="text-base font-bold text-slate-700 block mb-3.5">तुमचे मुख्य आर्थिक ध्येय निवडा:</label>
            ...
            {[
              ...
              <button
                ...
                className={`px-4 py-4 rounded-2xl text-xs font-bold border transition-all flex flex-col items-center space-y-2 ${
                  goalType === goal.id
                    ? "bg-violet-500/10 border-violet-300 text-violet-800 shadow-sm"
                    : "bg-white border-slate-200 text-slate-600 hover:border-slate-300"
                }`}
              >
        ...
        <div>
          <div className="flex justify-between items-center mb-3">
            <label className="text-base font-bold text-slate-700">ध्येय रक्कम (Target Amount)</label>
            <span className="text-lg font-extrabold text-violet-700 bg-violet-50 px-3 py-1 rounded-xl border border-violet-100">
        ...
        <div>
          <div className="flex justify-between items-center mb-3">
            <label className="text-base font-bold text-slate-700">कालावधी (Time Frame)</label>
            <span className="text-lg font-extrabold text-violet-700 bg-violet-50 px-3 py-1 rounded-xl border border-violet-100">
              {goalYears} वर्षे
            </span>
          </div>
        ...
        <div>
          <label className="text-base font-bold text-slate-700 block mb-3">जोखीम पत्करण्याची तयारी (Risk Appetite):</label>
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              <button
                ...
                className={`px-4 py-3 rounded-2xl border transition-all text-left flex flex-col justify-between ${
                  riskProfile === risk.id
                    ? "bg-violet-500/10 border-violet-300 text-violet-800"
                    : "bg-white border-slate-200 text-slate-600 hover:border-slate-300"
                }`}
              >
      ...
      <div className="lg:col-span-5 flex flex-col justify-between bg-slate-50/80 border border-slate-100 p-8 rounded-3xl">
        <div className="space-y-6">
          <h3 className="text-lg font-bold text-slate-800">ध्येय प्राप्तीचे सूत्र</h3>

          <div className="bg-white p-6 rounded-2xl border border-violet-100 shadow-sm text-center space-y-4">
            <div className="inline-flex p-3 bg-violet-50 rounded-2xl text-violet-600">
              <Target className="h-6 w-6" />
            </div>
            <div className="space-y-1">
              <span className="text-xs font-bold text-slate-400 uppercase block">आवश्यक मासिक SIP गुंतवणूक</span>
              <span className="text-2xl md:text-3xl font-extrabold text-violet-800 block">
        ...
        <div className="bg-violet-50 border border-violet-100 p-4.5 rounded-2xl space-y-2 mt-6">
          <h4 className="text-xs font-bold text-violet-800">💡 बजेटकट्टा शिफारस:</h4>
          <p className="text-[11px] text-violet-700/95 leading-relaxed">
...
export default function CalculatorsHub() {
  ...
  return (
    <section id="calculators" className="py-20 px-6 bg-slate-50/60 border-y border-slate-100 relative">
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-14">
          <span className="text-xs font-bold text-teal-600 bg-teal-50 px-3 py-1.5 rounded-full border border-teal-100 uppercase tracking-widest">कॅल्क्युलेटर कट्टा</span>
        ...
        <div className="flex justify-center mb-12">
          <div className="flex flex-wrap justify-center gap-2 bg-white/70 backdrop-blur-xl border border-white/60 p-2 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.02)] max-w-full overflow-x-auto">
            {[
              { id: "sip", label: "📈 SIP कॅल्क्युलेटर", color: "text-emerald-700" },
              { id: "fd", label: "🏦 FD कॅल्क्युलेटर", color: "text-amber-700" },
              { id: "emi", label: "📊 कर्ज EMI कॅल्क्युलेटर", color: "text-blue-700" },
              { id: "insurance", label: "🛡️ विमा नियोजन", color: "text-rose-700" },
              { id: "budget", label: "💼 ५०/३०/२० बजेट", color: "text-indigo-700" },
              { id: "goal", label: "🎯 ध्येय नियोजक", color: "text-violet-700" },
            ].map((tab) => (
              <button
                key={tab.id}
        ...
        <div className="bg-white/80 backdrop-blur-2xl border border-white/80 rounded-[32px] shadow-[0_25px_60px_rgba(0,0,0,0.03)] p-6 md:p-10">
