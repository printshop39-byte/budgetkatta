...
export const i18n: Record<Language, Record<string, string>> = {
  ...
  hi: {
    ...
    'hero.cta_primary': 'अभी तुलना करें',
    'hero.cta_secondary': 'दस्तावेज़ देखें',
    ...
    // --- UX pass v2 ---
    'nav.cta_short': 'मुफ्त मार्गदर्शन',
    'trust.educational': 'शैक्षणिक उद्देश्य',
    'home.how_title': 'यह कैसे काम करता है?',
    'home.how_1': 'जानकारी चुनें',
    'home.how_2': 'दर और EMI देखें',
    'home.how_3': 'दस्तावेज़ तैयार रखें',
    'home.calc_title': 'कैलकुलेटर एक क्लिक में',
    'fd.hero_title': 'सबसे अच्छे FD दर खोजें',
    'fd.trust_signal': 'सुरक्षित बैंक जानकारी',
    'fd.guidance_cta': 'FD के लिए मार्गदर्शन चाहिए',
    'fd.col_docs': 'दस्तावेज़',
    'fd.col_action': 'कार्रवाई',
    'fd.tenure_all': 'सभी अवधि',
    'sip.intro': 'हर महीने थोड़ी राशि निवेश करें और लंबे समय में वृद्धि देखें.',
    'sip.risk_title': 'जोखिम प्रकार समझें',
    'sip.risk_equity': 'इक्विटी — उच्च जोखिम',
    'sip.risk_hybrid': 'हाइब्रिड — मध्यम जोखिम',
    'sip.risk_debt': 'डेट — कम जोखिम',
    'sip.guidance_cta': 'SIP शुरू करने के लिए मार्गदर्शन लें',
    'ins.guidance_cta': 'बीमा मार्गदर्शन लें',
    'ins.types_title': 'बीमा के प्रकार',
    'ins.what_is': 'यह क्या है?',
    'ins.who': 'किसके लिए?',
    'ins.benefits': 'मुख्य लाभ',
    'ins.check': 'खरीदने से पहले जांचें',
