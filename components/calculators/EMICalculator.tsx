...
export default function EMICalculator() {
  ...
  return (
    <div className="glass-card glass-card-gold space-y-5 p-6">
      <h3 className="font-display text-xl font-bold text-white">{t('loan.emi_title')}</h3>

      <div className="space-y-4">
        <div>
          <div className="mb-1 flex justify-between">
            <label className="text-sm text-white/70 font-deva">{t('loan.amount')}</label>
        ...
        <div>
          <div className="mb-1 flex justify-between">
            <label className="text-sm text-white/70 font-deva">{t('loan.rate')}</label>
        ...
        <div>
          <div className="mb-1 flex justify-between">
            <label className="text-sm text-white/70 font-deva">{t('loan.tenure_month')}</label>
