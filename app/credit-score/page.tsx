    ...
    <PageShell titleKey="cs.title" subtitleKey="cs.subtitle" narrow>
      <div className="space-y-5">
        <section className="glass-card glass-card-gold p-6">
          ...
          <p className="mt-1.5 leading-relaxed text-white/75 font-deva">{creditScore.whatIs.body[language]}</p>
        </section>

        <section className="glass-card p-6">
          <h2 className="font-display text-lg font-bold text-bk-gold">{creditScore.whyMatters.title[language]}</h2>
          <p className="mt-1.5 leading-relaxed text-white/75 font-deva">{creditScore.whyMatters.body[language]}</p>
        </section>
        ...
        <p className="rounded-lg border border-white/5 bg-white/[0.03] px-3 py-2 text-xs text-white/45 font-deva">
