...
export default function FDCalculator() {
  ...
  return (
    <div className="glass-card glass-card-gold space-y-5 p-6">
      <h3 className="font-display text-xl font-bold text-slate-100">{t('fd.calc_title')}</h3>

      <div className="space-y-4">
        <div>
          <div className="mb-1 flex justify-between">
            <label className="text-sm text-slate-400 font-deva">{t('fd.amount')}</label>
        ...
        <div>
          <div className="mb-1 flex justify-between">
            <label className="text-sm text-slate-400 font-deva">{t('fd.rate')}</label>
        ...
        <div>
          <div className="mb-1 flex justify-between">
            <label className="text-sm text-slate-400 font-deva">{t('fd.tenure')}</label>
        ...
        <label className="flex cursor-pointer items-center gap-2 text-sm text-slate-400 font-deva">
          <input
            type="checkbox"
            checked={senior}
