...
export const i18n: Record<Language, Record<string, string>> = {
  ...
  mr: {
    ...
    'calc.tab.insurance': 'विमा नियोजन',
    ...
    'calc.goal.risk_low': 'कमी (कमी परतावा - सुरक्षित)',
    'calc.goal.risk_low_desc': 'एफडी / डेट फंड',
    'calc.goal.risk_med': 'मध्यम (संतुलित)',
  ...
  en: {
    ...
    'calc.tab.insurance': 'Insurance Planner',
    ...
    'calc.goal.risk_low': 'Low (Lower returns - Safe)',
    'calc.goal.risk_low_desc': 'FD / Debt Funds',
    'calc.goal.risk_med': 'Medium (Balanced)',
