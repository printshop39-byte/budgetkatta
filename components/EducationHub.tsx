...
export default function EducationHub() {
  ...
  const articles = [
    ...
    },
    {
      ...
      color: "border-emerald-100 bg-emerald-50/30 text-emerald-800",
    ...
    },
    {
      ...
      btnColor: "text-blue-700 hover:bg-blue-100",
    },
  ];

  return (
    <section id="literacy" className="py-20 px-6 max-w-7xl mx-auto border-t border-slate-100">
      <div className="text-center max-w-3xl mx-auto mb-14">
        <span className="text-xs font-bold text-emerald-600 bg-emerald-50 px-3 py-1.5 rounded-full border border-emerald-100 uppercase tracking-widest">आर्थिक साक्षरता</span>
        <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 mt-4 tracking-tight">चला पैशांची भाषा शिकूया!</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {articles.map((item, idx) => (
          ...
          >
            <div>
              <div className="inline-flex p-3 bg-white rounded-2xl shadow-sm border border-slate-100 mb-5">{item.icon}</div>
              <h3 className="text-lg font-bold text-slate-800 mb-3 tracking-tight leading-snug">{item.title}</h3>
