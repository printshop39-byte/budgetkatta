    ...
    <section className="px-4 py-10">
      <div className="mx-auto grid max-w-5xl grid-cols-1 gap-4 md:grid-cols-2">
        ...
        >
          ...
          <div>
            <h3 className="font-display text-lg font-bold text-white group-hover:text-bk-gold font-deva">
              {t('home.docs_cta')}
            </h3>
            <p className="mt-1 text-sm text-white/55 font-deva">{t('home.docs_sub')}</p>
          </div>
        ...
        >
          ...
          <div>
            <h3 className="font-display text-lg font-bold text-white font-deva">{t('home.guide_title')}</h3>
            <p className="mt-1 text-sm text-white/55 font-deva">{t('home.guide_sub')}</p>
          </div>
        </motion.button>
      </div>
    </section>
