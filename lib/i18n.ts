...
export const i18n: Record<Language, Record<string, string>> = {
  ...
  mr: {
    ...
    'calc.budget.needs_over': 'आपका गरजांवरील खर्च निश्चित मर्यादेपेक्षा जास्त आहे!',
    'calc.budget.wants_over': 'तुमच्या चैनीच्या वस्तू व इच्छेवर जास्त खर्च होत आहे. यात कपात करा.',
    'calc.budget.savings_low': 'तुमची गुंतवणूक ठरवलेल्या बचतीच्या लक्ष्यापेक्षा कमी आहे, यात वाढ करा!',
  ...
  en: {
    ...
    'calc.budget.needs_over': 'Your spending on Needs is over the recommended limit!',
    'calc.budget.wants_over': 'Your discretionary spending is too high. Consider cutting back.',
    'calc.budget.savings_low': 'Your investments are below the savings target — increase them!',
